            ...
            <div class="card-body">
                <div class="container-fluid px-4">
                    <div class="card-header">
                        <i class="fa fa-list fa-fw"></i>   Motivasyon Yazıları
                    </div>
                    <br>
                    <div class="row">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    foreach ($record as $key => $yazi):
                                        ...
                                        <tr>
                                            ...
                                            <td class="center"><?= $yazi->motivasyon_content; ?></td>
                                            <td class="center"><?= $yazi->motivasyon_author; ?></td>
                                            <td class="center"><?= $yazi->motivasyon_job; ?></td>
                                            <td class="center">
                                                <a href="#">
