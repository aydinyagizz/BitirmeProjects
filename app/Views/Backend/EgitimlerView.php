            ...
            <div class="card-body">
                <div class="container-fluid px-4">
                    <div class="card-header">
                        <i class="fa fa-list fa-fw"></i> Eğitimler
                    </div>
                    <br>
                    <div class="row">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php
                                    $say =1;
                                    foreach ($record as $key => $egitim):
                                        ?>

                                        <tr>
                                            <td><?= $say; ?></td>
                                            <td><img width="200" height="100" src="<?= base_url('assets/Backend/images/egitimler').'/'. $egitim->egitim_foto; ?>" alt="fotoğraf"></td>
                                            <td><?= $egitim->egitim_title; ?></td>


                                            <td class="center"><?= $egitim->egitim_tarih; ?></td>
                                            <td class="center">
                                                <a href="egitim-duzenle.php?yazi_id=<?= $egitim->egitim_id; ?>">
