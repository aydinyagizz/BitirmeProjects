            ...
            <div class="card-body">
                <div class="container-fluid px-4">
                    <div class="card-header">
                        <i class="fa fa-list fa-fw"></i> Ürünler
                    </div>
                    <br>
                    <div class="row">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php
                                    $say =1;
                                    foreach ($record as $key => $urunler):
                                        ?>

                                        <tr>
                                            <td><?= $say; ?></td>
                                            <td><img width="200" height="100" src="<?= base_url('assets/Backend/images/urunler').'/'. $urunler->urun_foto; ?>" alt="fotoğraf"></td>
                                            <td><?= $urunler->urun_title; ?></td>


                                            <td class="center"><?= $urunler->created_at; ?></td>
                                            <td class="center">
                                                <a href="duyuru-duzenle.php?yazi_id=<?= $urunler->urun_id; ?>">
